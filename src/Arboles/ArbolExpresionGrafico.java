...
public class ArbolExpresionGrafico extends JPanel {
    ...
    private void calcularPosiciones() 
    {
         posicionNodos.clear();
         subtreeSizes.clear();
         Empleado root = this.miArbol.getRaiz();
         if (root != null) 
         {
     ...
     */
    private Dimension calcularTamañoSubarbol(Empleado n) 
    {
          if (n == null) 
     ...
     */
    private void calcularPosicion(Empleado n, int left, int right, int top) 
    {
      if (n == null) 
          return;
      ...
      int width = fm.stringWidth(n.getAñosServicio()+"");
     ...
     */
    private void dibujarArbol(Graphics2D g, Empleado n, int puntox, int puntoy, int yoffs) 
    {
     if (n == null) 
         return;
     ...
     g.draw(r);
     g.drawString(n.getAñosServicio()+"", r.x + 3, r.y + yoffs);
